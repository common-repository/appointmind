...
class AppointmindWidget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            'appointmind_widget', 
            $this->__('Appointmind Calendar'), 
            [
                'description' => esc_html($this->__('Displays a link to your calendar in the sidebar. A click on that link opens a popup window.')),
                'classname' => 'widget_appointmind_calendar',
            ]
        );
    }
